        ...
        {isMenuOpen && (
          <div className="md:hidden bg-[#7A0B18] border-t border-white/20">
            <div className="px-4 py-4 space-y-3">
              <a href="#home" className="block text-white hover:text-[#EFBF3A] py-2">{t('nav.home')}</a>
              <a href="#products" className="block text-white hover:text-[#EFBF3A] py-2">{t('nav.products')}</a>
              <a href="#process" className="block text-white hover:text-[#EFBF3A] py-2">{t('nav.process')}</a>
              <a href="#distributors" className="block text-white hover:text-[#EFBF3A] py-2">{t('nav.distributors')}</a>
              <a href="#contact" className="block text-white hover:text-[#EFBF3A] py-2">{t('nav.contact')}</a>
              <button 
                onClick={toggleLanguage}
